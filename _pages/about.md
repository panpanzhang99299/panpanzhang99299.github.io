...
News
============
* Our method paper "Variational Bayesian inference for bipartite mixed-membership stochastic block model with applications to collaborative filtering" is tentatively accepted for publication on <i>Computational Statistics and Data Science</i>. The draft is available on [Arxiv](https://arxiv.org/pdf/2305.05350.pdf). This is a joint work with Zifeng Ye (USTC) and Professors Kun Chen (UConn) and Jie Liu (USTC).
...
* I will present "A Journey of Link Prediction Problems in Functional Brain Networks" in an invited session at [SMI 2023](https://www.sph.umn.edu/events-calendar/statistical-methods-in-imaging-2023/) (SMI 2023), Minneapolis, MN, USA. This is a joint work with Professor [Xiaojing Wang](https://xiaojing-wang.uconn.edu/) from UConn.
