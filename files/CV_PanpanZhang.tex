...
d	\section*{Teaching Activities}
	...
	\begin{enumerate}							 			
		...
		\item {\sc Hu, Z., Li, W., Yan, J.} and \PZ (2025+). 
		...
		(2025+). When does the silhouette score work? A comprehensive
	...
	\begin{enumerate}
		...
		\item {\sc \teal{Pan, Y.$^\dagger$}, Xie, S.\ X.} and 
		\PZ\
		(2025+) Statistical and deep learning methods for missing 
		covariates: A comparative review with applications to 
