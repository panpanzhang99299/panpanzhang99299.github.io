...
PMCID: PMC#2}}
\def \PMIDonly #1{\href{https://pubmed.ncbi.nlm.nih.gov/#1}{PMID: #1}}
\usepackage{soul}
...
\newcommand{\PZ}{\textcolor{purple}{\textbf{Zhang, P.*}}}
\newcommand{\PZnot}{\textcolor{purple}{\textbf{Zhang, P.}}}
\definecolor{pennblue}{RGB}{1, 31, 91} 
\newcommand{\pennblue}[1]{\textcolor{pennblue}{#1}}
...
\begin{document}
	...
	\begin{itemize}
		...
		Biostatistics, Epidemiology and Informatics, Perelman School of Medicine, University of Pennsylvania, Philadelphia, PA \hfill 08/2018 -- 08/2022
		\item {\bf Assistant Professor of Biostatistics (tenure 
		track),} Department of Biostatistics, Vanderbilt University 
		School of Medicine, Nashville, TN \hfill 09/2022 -- present
		\item {\bf Assistant Professor of Neurology (secondary),} 
		Department of Neurology, Vanderbilt University School of 
		Medicine, Nashville, TN \hfill \mbox{09/2022 -- present}
		...
		Core, Vanderbilt Alzheimer's Disease Research Center, 
		Vanderbilt University Medical Center, Nashville, TN \hfill 
		\mbox{09/2024 
		-- present}
	\end{itemize}
	...
	\begin{itemize}
		...
		Imaging Section} \hfill \mbox{06/2023 -- 12/2025}
		...
		\item {\bf Elected Member}, Scientific Review Committee, 
		...
		New Researchers in Statistics and Probability (New 
		Researchers Conference [NRC 2025]), Nashville, TN \hfill 
		2025
		\item {\bf Local Committee (Co-Chair)}, IMS Workshop on 
		Frontiers in Statistical Machine Learning (FSML 2025), 
		Nashville, TN \hfill 2025
		\item {\bf Technical Team Member}, 
		\href{https://statsupai.org/}{Stats Up AI Alliance} \hfill 
		\mbox{03/2025 -- present}
		\item {\bf Program Chair--Elect}, 
		\href{https://sdsaamstat.github.io/SDSA_website/}{ASA 
		Statistics and Data Science in Aging Interest Group} 
		\hfil{\mbox{01/2026 -- present}} 
		\item {\bf Scientific Advisory Committee,} Statistical 
		Methods in Imaging Conference (SMI 2026), Ann Arbor, MI 
		\hfill \mbox{2026}
	\end{itemize}
	...
	\begin{enumerate}
		...
		\item Current Developments in Nutrition
		...
		\item Journal of Child Psychology and Psychiatry
		...
		\item Proceedings of the National Academy of Sciences of the 
	...
	\end{enumerate}
	\subsubsection*{Student Paper Award Competitions}
	\begin{enumerate}
		\item SMI 2025
		\item JSM 2025: ASA Sections on (1) Statistical Computing and 
		(2) Statistics in Epidemiology
		\item ENAR 2026
		\item ICSA 2026
		\item JSM 2026: ASA Sections on (1) Statistics in 
		Epidemiology and (2) Statistics in Imaging
		\item SMI 2026
	\end{enumerate}
	...
	\begin{itemize}
		...
		DC \hfill 2016
		\item {\bf Excellence in Teaching Award,} University of 
		Connecticut, Storrs, CT \hfill Fall 2017
		\item {\bf Excellence in Teaching Award,} University of Connecticut, 
		Storrs, CT \hfill Spring 2018
		\item {\bf Research Education Component (REC) Scholar,} 
		Vanderbilt Alzheimer's Disease Research Center, Nashville, 
		TN \hfill 2025
		\item {\bf Art Wheeler Studio Award,}  Vanderbilt Institute 
		for Clinical and Translational Research (VICTR), Nashville, 
		TN \hfill 2025
		\item {\bf Elected Member,} 
		\href{https://isi-web.org/}{International Statistical 
		Institute} \hfill 2026
		\item {\bf Patrick G.\ Arbogast Collaborative Publication 
		Award,} Department of Biostatistics, Vanderbilt University 
		School of Medicine, Nashville, TN \hfill 2026 
	\end{itemize}
	...
	\begin{itemize}
		\item {\bf Instructor} (co-instructed with Dr.\ Dandan Liu), 
		Department 
		of Biostatistics, Biostatistics {\rm I} (MSCI 5009, contact hours: 10 
		hours per week) \hfill September 2022
	...
	\begin{enumerate}
		...
		\item Haoyang Yi, Ph.D.\ candidate,  Department of 
		Biostatistics, Vanderbilt University Medical Center, 2027 
		(expected)
		\item Yisu Yang, Ph.D.\ candidate, Neuroscience Graduate 
		Program, Vanderbilt University School of Medicine, 2030 
		(expected)
	\end{enumerate}
	...
	\begin{enumerate}
		\item Zongyue Teng (co-advised by Dr.\ Dandan Liu), Ph.D., 
		Department of Biostatistics, Vanderbilt University Medical 
		Center, 2029 (expected)
	\end{enumerate}
	...
	\begin{enumerate}
		...
		{\em \underline{First placement:}} Ph.D.\ 
		student in Biostatistics, Vanderbilt University Medical 
		Center
		\item Yiqing Pan, M.S., Department of Biostatistics, 
		Vanderbilt University Medical Center, 2026
		
		{\em \underline{First placement:}} Ph.D.\ 
		student in Epidemiology and Biostatistics, Indiana 
		University (Bloomington)
		
		\item Nuo Hu, M.S., Department of Biostatistics, Vanderbilt 
		University Medical Center, 2027 (expected)
	\end{enumerate}

	\section*{Research Programs}
	\subsection*{Present Funding}
	\begin{enumerate}
		\item P30AG086403 (NIA) \hfill 06/01/2025 -- 
		03/31/2030
		...
		\item R01AG089200 (NIA) \hfill 09/23/2024 -- 
		05/31/2029
		...
		\item R01AG034962 (NIA) \hfill 06/01/2020 -- 03/31/2026
		...
		\item U24AG074855 (NIA) \hfill 10/01/2021 -- 08/31/2026
	...
	\begin{enumerate}		
		\item P20AG068082 (NIA) \hfill 08/15/2020 -- 
		07/31/2024
		...
		\item R01AG062826 (NIA) \hfill 02/01/2020 -- 01/31/2025
		...
		\item R01EB017230 (NIBIB) \hfill 09/20/2015 -- 06/30/2026
		
		{\bf PI:} Bennett A.\ Landman (Angela L.\ Jefferson [VUMC 
		Site PI])
	...
	{\bf \textcolor{purple}{($\ast$ refers to the corresponding 
	author)}}
	
	\noindent {\bf \textcolor{teal}{($\dagger$ refers to my 
	...
	\begin{enumerate}
		...
		\pennblue{\bf \em (Equal Contribution)}
		...
		T.\ J., Held-Beason, L.\ L., Resnick, S.\ M., Winzeck, S., 
		...
		Cambronero, F.\ E., Risacher, S.\ L., Beason-Held, L.\ L., 
		An, Y., Arfanakis, K., Erus, G., Davatzikos, C., Tosun, D., 
		Toga, A.\ W., Thompson, P.\ M.,  Mormino, E.\ C., Habes, 
		M., Eang, D.,} \PZnot, {\sc Schilling, K., The Alzheimer’s 
		Disease Neuroimaging Initiative (ADNI), The BIOCARD Study 
		Team, The Alzheimer’s Disease Sequencing Project (ADSP), 
		Albert, M., Kukull, W., Biber, S.\ A., Landman, B.\ A., 
		Johnson, S.\ C., Schneider, J., Barnes, L.\ L., Bennett, D.\ 
		A., Jefferson, A.\ L., Resnick, S.\ M., Saykin, A.\ J., 
		Hohman, T.\ J.} and {\sc Archer, D.\ B.*} (2024). Sex, 
		racial, and APOE-$\varepsilon 4$ allele differences in 
		longitudinal white matter microstructure in multiple cohorts 
		of aging and Alzheimer’s disease. {\em Alzheimer's \& 
		Dementia}, {\bf 21}(1), e14343. 
		\DOI{10.1002/alz.14343}
		\PMID{39711105}{11781133}
		
		\item {\sc Neal, J.\ E.}, \PZnot\ and {\sc Liu, D.*} 
		(2025). Predictive partly conditional models for 
		longitudinal ordinal outcomes with application to 
		Alzheimer's disease	progression. {\em Statistics in 
		Biosciences}, {\bf 17}, 233--250. 
		\DOI{10.1007/s12561-024-09433-w}
		
		\item \PZ\ and {\sc Mahmoud, H.\ M.} (2025). The Sackin 
		index and depth of leaves in generalized Schr\"{o}der trees. 
		{\em Stochastic Models}, {\bf 41}(2), 208--226. \MR{4897081} 
		\DOI{10.1080/15326349.2024.2353061}
		
		\item \PZ\ (2025). Impact of early alcohol consumption on 
		adolescent development: Commentary on a longitudinal study 
		conducted by Ferariu et al.\ (2024). {\em Alcohol, Clinical 
		and Experimental Research}, {\bf 49}(1), 99--101. 
		\DOI{10.1111/acer.15497} \PMIDonly{39566966}
		...
		\PMID{39780864}{11705531}
		
		\item \PZ\ (2025). Discussion of ``Power priors for 
		leveraging historical data: Looking back and looking 
		forward''. {\em Journal of Data Science}, {\bf 23}(1), 
		62--63. \DOI{10.6339/25-JDS1161B}
		
		\item {\sc Shen, A., Feng, Q., Yan, J.} and \PZ\ (2025). 
		Rank-based assortativity for weighted, directed networks. 
		{\em Journal of Complex Networks}, {\bf 13}(2), cnaf002. 
		\MR{4879460} \DOI{10.1093/comnet/cnaf002}
		
		\item {\sc Louit, S., Clark, E.\ A., Gelbard, A.\ H., Vivek, 
		N., Yan, J.} and \PZ\ (2025). CALF-SBM: A 
		covariate-assisted latent factor stochastic block model. 
		{\em Physica A: Statistical Mechanics and its Applications}, 
		{\bf 667}, 130536. \MR{4884303} 
		\DOI{10.1016/j.physa.2025.130536} \PMID{42147753}{13178508}
		
		\pennblue{\bf \em An earlier version of this paper was 
		selected 
		as one of the winners of the student paper competition for 
		the 
		\href{https://community.amstat.org/spes/discussion/spes-qp-student-paper-competition-results/}{ASA
		Sections on Physical and Engineering Sciences (SPES) and 
		Quality and Productivity (Q\&P)} in 2025.}
	
		\item  {\sc Zhong, K., Castro, L.\ M.*,} \PZnot\ and {\sc 
		Lachos, V.\ H.} (2025). Autoregressive Bayesian modeling of 
		censored HIV longitudinal data using the multivariate 
		student’s-$t$ distribution. {\em Japanese Journal of 
		Statistics and Data Science}, {\bf 8}(1), 743--770. 
		\MR{4921675} \DOI{10.1007/s42081-025-00299-w}
		
		\item {\sc Lorenz, A., Sathe, A., Zaras, D., Yang, Y., 
		Durant, A., Kim, M.\ E., Gao, C., Newlin, N.\ R., Ramadass, 
		K., Kanakaraj, P., Khairi, N.\ M., Li, Z., Yao, T., Huo, Y., 
		Dumitrescu, L., Shashikumar, N., Pechman, K.\ R., Jackson, 
		T.\ B., Workmeister, A.\ W., Risacher, S.\ L., Beason-Held, 
		L.\ L., An, Y., Arfanakis, K., Erus, G., Davatzikos, C., 
		Habes, M., Wang, D., Tosun, D., Toga, A.\ W., Thompson, P.\ 
		M., Mormino, E.\ C.,} \PZnot, {\sc Schilling, K.\ G., The 
		Alzheimer’s Disease Neuroimaging Initiative (ADNI), The 
		BIOCARD Study Team, The Alzheimer’s Disease Sequencing 
		Project (ADSP), Albert, M., Kukull, W., 	Biber, S.\ A., 
		Landman, B.\ A., Johnson, S.\ C., Bendlin, B., Schneider, J., 
		Barnes, L.\ L., Bennett, D.\ A., Jefferson, A.\ L., Resnick, 
		S.\ M., Saykin, A.\ J., Hohman, T.\ J.} and {\sc Archer, 
		D.\ B.*} (2025). The effect of Alzheimer's disease genetic 
		factors on limbic white matter microstructure. {\em 
		Alzheimer's \& Dementia}, {\bf 21}(4), e70130. 
		\DOI{10.1002/alz.70130} \PMID{40219815}{11992597}
		...
		in aging and Alzheimer’s disease. {\em JAMA Neurology}, {\bf 
		82}(8), 825--836. \DOI{10.1001/jamaneurol.2025.1601} 
		\PMID{40513084}{12150229}
		...
		Jefferson, A.\ L.*} (2025). Increased sedentary behavior is 
		associated with neurodegeneration and worse cognition in 
		older adults over a 7-year period despite high levels of 
		physical activity. {\em Alzheimer's \& Dementia}, {\bf 
		21}(5), e70157. \DOI{10.1002/alz.70157}  
		\PMID{40357887}{12070248}
		
		\item {\sc Adegboye, H.\ A., Patterson, K.\ L., Libby, J., 
		...
		follow-up. {\em Alzheimer's \& Dementia}, {\bf 21}(6), 
		e70276. \DOI{10.1002/alz.70276} \PMID{40469059}{12138273}
		...
		T.\ J.} and {\sc Liu, D.*} (2025). The dynamics of 
		cognitive decline towards Alzheimer’s disease progression: 
		Results from ADSP-PHC’s harmonized cognitive composites. 
		{\em Alzheimer's \& Dementia}, {\bf 21}(6), e70335. 
		\DOI{10.1002/alz.70335} \PMID{40538025}{12179338} 
		\pennblue{\bf \em (Co-First Authorship: Kang, K.\ and 
		\PZnot)} 
		
		\pennblue{\bf \em An earlier version of this paper was 
		selected as one of the winners of the student paper 
		competition for the 
		\href{https://nestat.org/researchawards/nessresearch2024/}{New
		 Englang Statistics Symposium} in 2024.}
		
		\item \PZnot\ and {\sc Xie, S. X.*} (2025). Bias and 
		efficiency comparison between multiple imputation and 
		available-case analysis for missing data in longitudinal 
		models. Accepted for publication in {\em Statistics in 
		Biosciences} (available online). 
		\DOI{10.1007/s12561-025-09493-6} \PMID{40821499}{12356228}
		
		\item {\sc Nolan, E., Sun, Y., Shi, H., Perry, A., Pechman, 
		K., Shashikumar, N., Landman, B., Gogniat, M., Liu, D.,} 
		\PZnot, {\sc Hohman, T.\ J., Jefferson, A.\ L.} and {\sc 
		Full, K.*} (2025). The association between poor sleep 
		health and Alzheimer’s disease structural neuroimaging 
		biomarkers. {\em Alzheimer's \& Dementia}, {\bf 21}(6), 
		e70364. \DOI{10.1002/alz.70364} \PMID{40545560}{12183099}
		...
		Collaborative publishing relationships by gender. {\em 
		Laryngoscope} (available online). 
		\DOI{https://doi.org/10.1002/lary.32394} 
		\PMID{40600265}{12335869}
		...
		Jefferson, A.\ L.*} (2025).Cross-sectional and longitudinal 
		associations of neighborhood disadvantage with fluid 
		biomarkers of neuroinflammation and neurodegeneration. {\em 
		Neurology}, {\bf 105}(2), e213770. 
		\DOI{10.1212/WNL.0000000000213770} \PMID{40561381}{12203597}
		
		\item {\sc Stirland, L.\ E.*, Choate, R., Zanwar, P.\ P.}, \PZnot, {\sc 
		Watermeyer, T.\ J., Valletta, M., Torso, M., Tamburin, S., Saeed, U., 
		Ridgway, G.\ R., Moukaled, S., Lusk, J.\ B., Loi, S.\ M., Littlejohns, 
		T.\ J., Ku\'{z}ma, E., James, S.\ N., Grande, G., Foote, I.\ F., 
		Cousins, K.\ A.\ Q., Butler, J., AbuHamdia, A., Avelino-Silva T.\ J.} 
		and {\sc Suryadevara, V.} (2025). Multimorbidity in dementia: Current 
		perspectives and future challenges. {\em Alzheimer's \& Dementia}, {\bf 
		21}(8), e70546. \DOI{10.1002/alz.70546} 
		\PMID{40755143}{12319240}
		
		\item {\sc Bolton, C.\ J.,} \PZnot, {\sc Nair, D., Liu, D., 
		Davis, L.\ T., Pechman, K.\ R., Shashikumar, N., Wilhoite, 
		S., Roby, D., Corey, C., Komorowski, H., Giffort, K.\ A., 
		Hohman, T.\ J.} and {\sc Jefferson, A.\ L.*} (2025). Mild 
		kidney dysfunction affects the predictive accuracy of 
		blood-based biomarkers for neuropsychological and 
		neuroimaging outcomes over a 9-year follow-up period. {\em 
		Alzheimer's \& Dementia}, {\bf 21}(9), e70651. 
		\DOI{10.1002/alz.70651} \PMID{40970383}{12447110}
		
		\item {\sc Bolton, C.\ J.,} \PZnot, {\sc Wilhoite, S.\ R., 
		Moore, E.\ E., Houston, M.\ L., Pechman, K.\ R., Dumitrescu, 
		L., Peterson, A., Khan, O.\ A., Liu, D., Giffort, K.\ A., 
		Blennow, K., Hohman, T.\ J., Zetterberg, H.} and {\sc 
		Jefferson, A.\ L.*} (2025).	Increased neuroplastic activity 
		in the pathogenesis of Alzheimer's disease. {\em Alzheimer's 
		\& Dementia}, {\bf 21}(11), e70897. \PMID{41315049}{12662745}
		...
		and {\sc Jefferson, A.\ L.*} (2026). Plasma von Willebrand 
		factor and ADAMTS13 interact with APOE-$\varepsilon$4 in 
		predicting longitudinal brain atrophy and cognitive decline 
		over a 9-year follow-up. {\em Journal of the American Heart 
		Association}, {\bf 15}(9), e043186. 
		\DOI{10.1161/JAHA.125.043186}
		
		\item {\sc Cambronero, F.}, \PZnot, {\sc Robb, W.\ H., Liu, 
		D., Pechman, K., Jackson, T., Shashikumar, N., Bown, C., 
		Hohman, T., Davis, L.} and {\sc Jefferson, A.\ L.*} (2026). 
		Posterior communicating artery variation is linked to 
		compromised cerebral hemodynamics in middle-aged and older 
		adults. {\em Journal of Cerebral Blood Flow and Metabolism}, 
		{\bf 46}(7), 1953--1966. \DOI{10.1177/0271678X261424053} 
		\PMID{41816815}{12982150}
		
		\item {\sc Bogdanov, S., Kanakaraj, P., Kim, M.\ E., Samir, 
		J., Gao, C., Ramadass, K., Rudravaram, G., Newlin, N.\ R., 
		Archer, D., Hohman, T.\ J., Jefferson, A.\ L., Morgan, V.\ 
		L., Roche, A., Englot, D.\ J., Resnick, S.\ M., Held, L.\ L.\ 
		B., Cutting, L., Barquero, L.\ A., D'Archangel, M.\ A., 
		Nguyen, T.\ Q., Humphreys, K.\ L., Niu, Y., Vinci-Booher, S., 
		Cascio, C.\ J., HABS-HD Study Team, Alzheimer’s Disease 
		Neuroimaging Initiative, BIOCARD Study Team, Li, Z., 
		Vandekar, S.\ N.}, \PZnot, {\sc Gore, J.\ C., Forkel, S.\ 
		J., Landman, B.\ A.} and {\sc Schilling, K.\ G.} (2026). 
		Lifespan trajectories of asymmetry in white matter tracts. 
		{\em Human Brain Mapping}, {\bf 47}(8), e70519. 
		\DOI{10.1002/hbm.70519} \PMID{42249731}{13241809}
		...
		and {\sc Schilling, K. G.*} (2026). White matter 
		microstructure and macrostructure brain charts across the 
		human lifespan. {\em Nature}, {\bf 655}(8124), 979--989. 
		\DOI{10.1038/s41586-026-10454-2} \PMID{42129567}{13391363}
		
		\item {\sc Moore, E.\ E.}, \PZnot, {\sc Khan, O.\ A., Liu, 
		D., Gupta, D.\ K., Pechman, K.\ R., Gifford, K.\ A., 
		Landman, B.\ A., Hohman, T.\ J.} and {\sc Jefferson, A.\ 
		L.*} (2026). Lower cardiac output is a risk factor for 
		faster cerebral atrophy over a 11-year follow-up period in 
		APOE-$\varepsilon$4 carriers. {\em Alzheimer's \& Dementia}, 
		{\bf 22}(8), e71598. \DOI{10.1002/alz.71598} 
		\PMID{42549659}{13435374}
		
		\item {\sc Lorenz, A.\ S., Sathe, A., Yang, Y., Durant, A., 
		Wu, Y., Kim, M.\ E., Gao, C., Newlin, N.\ R., Ramadass, K., 
		Kanakaraj, P., Khairi, N.\ M., Li, Z., Yao, T., Huo, Y., 
		Dumitrescu, L., Shashikumar, N., Pechman, K.\ R., Risacher, 
		S. L., Beason-Held, L.\ L., An, Y., Arfanakis, K., Erus, G., 
		Davatzikos, C., Habes, M., Wang, D., Tosun, D., Toga, A.\ W., 
		Thompson, P.\ M., Mormino, E.\ C.}, \PZnot, {\sc 
		Schilling, K., Albert, M., Kukull, W., Biber, S.\ A., 
		Landman, B.\ A., Johnson, S.\ C., Bendlin, B., Schneider, J., 
		Bennett, D.\ A., Jefferson, A.\ L., Resnick, S.\ M., Saykin, 
		A.\ J., Below, J.\ E., Hohman, T.\ J.} and {\sc Archer, D.\ 
		B.*, Alzheimer's Disease Sequencing Project (ADSP)} (2026). 
		Genetic architecture of the limbic white matter 
		microstructure in aging and Alzheimer's Disease. {\em 
		Alzheimer's \& Dementia}, {\bf 22}(7), e71630. 
		\DOI{10.1002/alz.71630}
		
		\item {\sc LeFevre, J.\ D., Vyas, Y., Sathe, A., Shashikumar, 
		N., Pechman, K.\ R., Yang, Y., Durant, A., Kanakaraj, P., 
		Kim, M.\ E., Gao, C., Newlin, N.\ R., Ramadass, K., Khairi, 
		N.\ M., Li, Z., Yao, T., Risacher, S.\ L.}, \PZnot, {\sc 
		Schilling, K.\ G., Lee, A.\ J., Brickman, A.\ M., Mayeux, R., 
		Mez, J., Alzheimer's Disease Neuroimaging Initiative (ADNI), 
		Alzheimer's Disease Sequencing Project (ADSP), ADSP Phenotype 
		Harmonization Consortium (ADSP‐PHC), Kukull, W., Biber, S.\ 
		A., Landman, B.\ A., Bendlin, B.\ B., Johnson, S.\ C., 
		Schneider, J., Barnes, L.\ L., Bennett, D.\ A., Saykin, A.\ 
		J., Cuccaro, M.\ L., Hohman, T.\ J., Jefferson, A.\ L.} and 
		{\sc Archer, D.\ B.*} (2026). The role of vascular risk 
		factors in white matter tract microstructure: A multi-cohort 
		study in older adults. {\em Alzheimer's \& Dementia}, {\bf 
		22}(8), e71698. \DOI{10.1002/alz.71698} 
		\PMID{42535262}{13425621}
		
		\item {\sc Robb, W.\ H., Santner, A.\ M.}, \PZnot, {Kim, D.\ 
		S., Jackson, T.\ B., Shashikumar, N., Pechman, K.\ R., Vyas, 
		Y., Liu, D., Davis, L.\ T., Hohman, T.\ J.} and 
		{\sc Jefferson, A.\ L.*} (2026). Arterial spin labeling 
		hemodynamic indices relate to cognitive and small vessel 
		disease trajectories over 11 years. {\em Stroke} (in press). 
	...
	\begin{enumerate}
		...
		\pennblue{\bf \em This package was selected as one of the 
		...
		\href{https://community.amstat.org/jointscsg-section/awards/john-m-chambers}{John
		 ...
		 (\href{https://community.amstat.org/jointscsg-section/home}{ASA
	  	...
	  	\item{\sc Louit, S., Yan J.} and \PZnot\ (2024). calfsbm: 
	  	Covariate-Assisted Latent Factor Stochastic Block Model. {\tt 
	  	R} package version 0.0.1,  
	  	\url{https://github.com/sydneylouit539/calfsbm}.
	  	
	  	\item \PZnot, {\sc Liu, D.} and {\sc Neal, J.} (2024).
	  	ppcm: Predictive Partly Conditional Model. {\tt R} package 
	  	version 
	  	0.0.0.1, \url{https://github.com/liud4/ppcm}.
	  	
	  	\item {\sc Khan, O.\, A., Liu, D.}, \PZnot\ and {\sc 
	  	Vanderbilt University Medical Center} (2025). rVMAP: A 
	  	Research Package for the Vanderbilt Memory and Aging Project 
	  	(VMAP). {\tt R} package version 
	  	1.5.1, \url{https://github.com/liud4/rVMAP}.
	  	
	  	\item {\sc Xiao, S., Yan, J.} and \PZnot\ (2026). grasps: 
	  	Groupwise Regularized Adaptive Sparse Precision Solution. 
	  	{\tt R} package version 0.1.1, 
	  	\url{https://cran.r-project.org/web/packages/grasps/index.html}
	\end{enumerate}
	
	\subsection*{Preprints}
	\begin{enumerate}		
		\item {\sc Vandekar, S.\ N.*,} \PZnot, {\sc Patel, K.\ R., 
		Jefferson, A.\ L.} and {\sc Harrell, F.} (2026). 
		Unreliability of biomarker research in psychiatry. Revision 
		invited by {\em JAMA Psychiatry}. \pennblue{\bf \em (Co-First 
		Authorship: Vandekar, S.\ N.\ and \PZnot)}
		
		\item {\sc Hu, Z., Li, W., Yan, J.} and \PZ (2026+). 
		Covariate connectivity combined clustering for weighted 
		networks. {\em ArXiv preprint} 
		(\DOI{10.48550/arXiv.2511.17302}). Revision invited by {\em 
		Physica A: Statistical Mechanics and its Applications}.
		
		\item \PZ, {\sc Xiao, S., Robb, W.\ H., Liu, D., Jefferson, 
		A.\ L.} and Yan, J. (2026+). Gaussian graphical models for 
		functional connectivity analysis: A statistical review with 
		applications to Alzheimer’s disease. {\em ArXiv preprint} 
		(\DOI{10.48550/arXiv.2604.10249}). Revision invited by {\em 
		...
		covariates in longitudinal models. Under review. 
		\pennblue{\bf 
		\em (Co-First 
		Authorship: Suttner, L.\ H.\ and \PZnot)}
		
		\item {\sc \teal{Teng, Z.$^\dagger$}, Yan, J.} and \PZ\ 
		(2026+). When does the silhouette score work? A comprehensive
		study in network clustering. {\em ArXiv preprint} 
		(\DOI{10.48550/arXiv.2512.24841}). Under review.
		
		\item {\sc \teal{Pan, Y.$^\dagger$}, Xie, S.\ X., Ma, S., 
		Jefferson, A.\ L.} and \PZ\ (2026+) Statistical and deep 
		learning methods for missing	covariates: A comparative review 
		with applications to Alzheimer’s disease research. Under 
		review.
		
		\item {\sc \teal{Teng, Z.$^\dagger$}, Adegboye, H.\ 
		A., Hohman, T.\ J., Jefferson, A.\ L., Liu, D.*} and \PZ\ 
		(2026+). SIGNET: A signed network spectral clustering method 
		for proteomic module discovery in Alzheimer’s disease. Under 
		review.
		
		\item {\sc \teal{Teng, Z.$^\dagger$}, Ma, S., Hohman, T.\ J., 
		Jefferson, A.\ L.} and \PZ\ (2026+). Bayesian variable 
		selection for high-dimensional predictors with missing 
		psychometric outcomes. {\em ArXiv preprint} 
		(\DOI{10.48550/arXiv.2609.11032}). Under review.
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\textbf{Topic:} Challenges and opportunities for longitudinal
		...
		\textbf{Topic:} Covariate-assisted community detection for
		functional brain networks: A variational approach
		
		\item Invited speaker at the spring meeting of the Eastern 
		North American Region (ENAR 2026), Indianapolis, IN, 2026.	
		
		\textbf{Topic:} A covariate-assisted community detection 
		algorithm applied to functional brain network data.
		
		\item Invited speaker at the ASA Philadelphia Chapter 
		Webinar Series, online, 2026.
		
		\textbf{Topic:}  SIGNET: A signed network spectral clustering 
		method for proteomic module discovery in Alzheimer’s disease
		
		\item Poster presenter at the REC Poster Session, 2026 Spring 
		ADRC Meeting, Atlanta, GA, 2026.
		
		\textbf{Topic:} The dynamics of cognitive decline toward 
		Alzheimer’s disease progression: Results from ADSP-PHC's 
		harmonized cognitive composites
		
		\item Invited speaker at the Statistical Methods in Imaging 
		Conference (SMI 2026), Ann Arbor, MI, 2026.
		
		\textbf{Topic:} Group-structured sparse precision matrix 
		estimation for interpretable functional brain networks
		
		\item Invited speaker at the 35th Annual Applied Statistics 
		Symposium for the International Chinese Statistical 
		Association (ICSA 2026), Arlington, VA, 2026. 
		
		\textbf{Topic:} Modern strategies for missing data 
		imputation: From adaptive kNN with feature selection to deep 
		learning models
		
		\item Invited speaker at the Joint Statistical Meetings (JSM 
		2026), Boston, MA, 2026.	
		
		\textbf{Topic:} A Bayesian model for network analysis under 
