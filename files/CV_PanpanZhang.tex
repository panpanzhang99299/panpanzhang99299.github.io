...
\begin{document}
	...
	\end{enumerate}
	\subsubsection*{Student Paper Competitions}
	\begin{enumerate}
		\item Student Paper Competition for the 2024 Annual Meeting 
		of the ASA Section on Statistical Methods in Imaging (SMI 
		2024) 
		\item Early Career Awards for the 2025 Joint Statistical 
		Meetings of the ASA Section on Statistics in Epidemiology 
		(JSM 2025, SIE Section)
	\end{enumerate}
...
\end{enumerate} 
	...
	\begin{enumerate}			
		...
		academic impact of physicians. Revision invited by {\em 
