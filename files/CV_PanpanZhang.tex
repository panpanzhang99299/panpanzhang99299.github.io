...
\begin{document}
	...
	\begin{enumerate}
		...
		9-year follow-up. {\em Journal of the American Heart 
		Association} (in press). \DOI{10.1161/JAHA.125.043186}
		
		\item {\sc Cambronero, F.}, \PZnot, {\sc Robb, W.\ H., Liu, 
		D., Pechman, K., Jackson, T., Shashikumar, N., Bown, C., 
		Hohman, T., Davis, L.} and {\sc Jefferson, A.\ L.*} (2025+). 
		...
		(in press). \DOI{10.1177/0271678X261424053} 
		\PMID{41816815}{12982150}
		
		\item {\sc Kanakaraj, P., Bogdanov, S., Kim, M.\ E., Samir, 
		...
		B.*, Alzheimer's Disease Sequencing Project (ADSP)}. Genetic 
		architecture of the limbic white matter microstructure in 
		aging and Alzheimer's Disease. {\em Alzheimer's \& Dementia}, 
		{\bf 22}(7), e71630. \DOI{10.1002/alz.71630}
	\end{enumerate} 
	...
	\begin{enumerate}							 			
		...
		(\DOI{10.48550/arXiv.2511.17302}). Under review.
		...
		(\DOI{10.48550/arXiv.2604.10249}). Under review.
		
		\item {\sc Vandekar, S.\ N.*,} \PZnot, {\sc Patel, K.\ R., 
		Jefferson, A.\ L.} and {\sc Harrell, F.} (2026+). 
		Unreliability of biomarker research in psychiatry. Under 
		review.	\pennblue{\bf \em (Co-First Authorship: Vandekar, 
		S.\ N.\ and	\PZnot)}
		
		\item {\sc Robb, W.\ H., Santner, A.,} \PZnot, {\sc Kim, D., 
		Jackson, T.\ B., Shahikumar, N., Pechman, K., Vyas, Y., Liu, 
		D., Davis, L., Hohman, T.\ J.} and {\sc Jefferson, A.\ L.} 
		(2026+) Arterial spin labeling hemodynamic indices relate to 
		cognitive and small vessel disease trajectories over 11 
		years. Under review.
	\end{enumerate}
