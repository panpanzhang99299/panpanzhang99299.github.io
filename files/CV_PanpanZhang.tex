...
\begin{document}
	...
	\begin{itemize}
		\item {\bf Organizer and Chair,} an invited session of New 
		England Statistical Symposium (NESS 2019), Storrs, CT
		\item {\bf Organizer and Chair,} an invited session of New 
		England Statistical Symposium (NESS 2022), Storrs, CT
		...
		2023, Anchorage, AK
		\item {\bf Organizer,} an invited session of New England 
		Statistical Symposium (NESS 2023), Boston, MA
	\end{itemize}
	...
	\begin{enumerate}
		...
		\href{https://doi.org/10.1080/09602011.2023.2203403}{\underline{DOI}}
		
		\item {\sc Yuan, Y., Wang, T., Yan, J.} and \PZnot\ (2023). 
		Generating general preferential attachment networks with R 
		package $\mathtt{wdnet}$. {\em Journal of Data Science}. In 
		press. 
		...
		Journal of Data Science}. In press. 
...
\end{enumerate} 
	...
	\begin{enumerate}	
		...
		in 
		regions specific to Alzheimer’s disease over a 6-year 
