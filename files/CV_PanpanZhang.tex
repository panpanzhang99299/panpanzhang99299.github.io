...
\begin{document}
	...
	\section*{Education}
	\begin{itemize}
		% \item B.A. in \textbf{Mathematics}, Dong Hua University, Shanghai, China \hfill 09/2005 -- 07/2009
	...
	\begin{itemize}
		\item {\bf Visiting Assistant Professor of Statistics,} Department of Statistics, University of Connecticut, Storrs, CT \hfill 08/2016 -- 08/2018 
		...
		\item {\bf Assistant Professor of Neurology (secondary),} Department of Neurology, Vanderbilt University Medical Center, Nashville, TN \hfill 09/2022 -- present
	\end{itemize}
	...
	\begin{itemize}
		...
		\item {\bf Chair,} an invited session of ICSA 2023 Applied Statistics Symposium, Ann Arbor, MI
	\end{itemize}
	...
	\begin{enumerate}
		...
		{\bf PI:} Angela Jefferson
		
		{\bf Title:} Vanderbilt Memory \& Aging Project
		
		{\bf Role:} Biostatistician (50\% FTE)
	...
	\begin{enumerate}
		...
		{\underline{DOI}} {\bf (joint first authorship)}
		...
		\item {\sc Domicolo, C.,} \PZ\ and Mahmoud, H.\ M. (2022). The degree Gini index of several classes of random trees and their poissonized counterparts---Evidence for duality. {\em Journal of Stochastic Analysis}, {\bf 3}(4), article no.\ 1.				
	\end{enumerate} 
