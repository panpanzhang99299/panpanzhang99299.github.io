...
\begin{document}
	...
	\begin{enumerate}		
		...
		\item {\sc \teal{Pan, Y.$^\dagger$}, Xie, S.\ X., Jefferson, 
		A.\ L.} and \PZ\ (2026+) Statistical and deep learning 
		methods for missing	covariates: A comparative review with 
		applications to Alzheimer’s disease research. Under review.
		
		\item {\sc \teal{Teng, Z.$^\dagger$}, Liu, D., Adegboye, H.\ 
		A., Hohman, T.\ J., Jefferson, A.\ L.} and \PZ\ 
