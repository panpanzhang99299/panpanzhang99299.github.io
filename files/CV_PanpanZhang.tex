...
\begin{document}
	...
	\begin{enumerate}
		...
		T.\ J.} and {\sc Liu, D.*} (2025+). The Dynamics of Cognitive 
		Decline towards Alzheimer’s Disease Progression: Results from 
		ADSP-PHC’s Harmonized Cognitive Composites. {\em Alzheimer's 
		\& Dementia} (in press). {\bf (co-first 
